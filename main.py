...
# ------------------------------------------------------
    ...
    def mostrar_input_usuario(self):
        ...
        texto_reloj = self.font.render(
            f"Tiempo: {int(self.tiempo_restante)}s", True, WHITE)
        self.pantalla.blit(texto_reloj, (SCREEN_WIDTH - 200, 100))
        # Respuestas
...
# ------------------------------------------------------
    ...
    def chequear_respuesta(self, respuesta):
        ...
        for pregunta, respuesta in self.pregunta_actual["respuestas"].items():
